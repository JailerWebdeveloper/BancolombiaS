        ...
        useEffect(() => {
            ...
            if (token) {
                ...
                setUserData({
                    ...
                    numero_de_cuenta: decodedToken.numero_de_cuenta,
                ...
                <main className="w-full min-h-screen bg-gray-100 ">
                    <div className="w-full h-full flex flex-col">
                        <div className="flex flex-col gap-5 bg-gray-700 relative">
                            ...
                            <div className="flex px-4 gap-4 z-10 items-center">
                                <h1 className="text-4xl text-white font-light capitalize mb-20">
                        ...
                        <section className="mt-10 px-6">
                            ...
                            <div className="bg-white flex flex-col text-black shadow-md p-4 mt-4">
                                <div className="flex justify-between items-center">
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-500">
                                            Ahorros {userData.numero_de_cuenta}
                                        </p>
                                    </div>
                                ...
                                <div className="self-end flex text-black items-end flex-col">
                                    ...
                                    <p className="text-3xl">${userData.saldo}</p>
                                </div>
                        ...
                        <section className="w-full flex mt-8 text-black px-5 flex-col">
                            ...
                            <div className="grid grid-cols-3 gap-4 w-full place-content-center">
                                ...
                                <Link to="/Transferencia" className="bg-white text-center btn btn-ghost w-full h-full justify-center items-center p-2 flex flex-col gap-4">
                                    <svg className="size-7 text-gray-800" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                                ...
                                <Link to="/Retiro" className="bg-white btn btn-ghost text-center w-full h-full justify-center items-center p-2 flex flex-col gap-4">
                                    ...
                                    <p className="text-gray-500 leading-tight">Retiro</p>
                                </Link>
                            </div>
                        </section>
                    </div>
